...
export default function SignInSide() {
  const [signIn, { data: userLogin, isLoading, isSuccess, isError, error }] =
    useSignInMutation();
  ...
  useEffect(() => {
    if (isSuccess) {
      ...
      toast.error("Username yoki parol xato kiritildi");
    }
  }, [isSuccess, isError, userLogin, navigate, dispatch]);
